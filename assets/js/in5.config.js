...
var prefix = (function () {
  	var styles = window.hasOwnProperty('getComputedStyle') ? window.getComputedStyle(document.documentElement, '') : {},
...
viewOpts = ({title:0, page:0, zoom:0, fs:0, pdf:0, toc:0, thumbs:0, progress:0, loadText:"loading content...", footer:0});
...
function clearLastPage($prevActive){
	...
	/*$prevActive.find('[data-id]').css(pre+'animation','none');*/
}
